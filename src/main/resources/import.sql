insert into tb_user (id, email, github_url, additional_url, name, password, active) values ('0a10cc2c-d527-44bc-912f-95ea6aa94961', 'breno@gmail.com', 'https://github.com/brenooduarte', 'www.linkedin.com/in/breno-freitas-duarte', 'Breno Duarte', '12345', true);
insert into tb_user (id, email, github_url, additional_url, name, password, active) values ('c114fe61-f54f-4858-9c4d-9f6d9d8207aa', 'harlon@gmail.com', 'https://github.com/HarlonGarcia', 'www.linkedin.com/in/harlon-garcia', 'Harlon Garcia', '54321', true);
insert into tb_user (id, email, github_url, additional_url, name, password, active) values ('3aec17ef-b1ac-45a0-9963-3a68583b41b5', 'pedro@gmail.com', 'https://github.com/Palc3301', 'www.linkedin.com/in/pedro-arruda', 'Pedro Arruda', '678910', true);
