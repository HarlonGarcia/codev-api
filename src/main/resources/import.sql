...
insert into tb_challenge (id, description, title, author_id) values (1, 'Fazer uma API do banco tal', 'API do banco tal', 1);
insert into tb_challenge (id, description, title, author_id) values (2, 'Fazer o front end do banco tal', 'Front end do banco tal', 2);
...
insert into tb_like (author_id, solution_id) values (1, 1);
insert into tb_like (author_id, solution_id) values (1, 2);
insert into tb_like (author_id, solution_id) values (2, 2);
insert into tb_like (author_id, solution_id) values (3, 2);